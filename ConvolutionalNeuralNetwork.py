...
cnnuspslabelmat = np.empty((19999,10))
print(len(uspsdata))
print(len(uspslabel))
...
print "test accuracy for mnist %g" % accuracy.eval(
    feed_dict={x: mnist.test.images, y_: mnist.test.labels, keep_prob: 1.0})
print "test accuracy for usps %g" % accuracy.eval(feed_dict={x: uspsdata, y_: cnnuspslabelmat, keep_prob: 1.0})